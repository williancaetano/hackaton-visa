            ...
            <Box className="app" textAlign="center" fontSize="xl">
                <Grid gap={0}>
                    ...
                    <div className="app-content">
                        ...
                        <StatusBoxSmall
                            type="bag"
                            status="bagagem no aviao"
                        ></StatusBoxSmall>
                        <StatusBoxSmall
                            type="air"
                            status="embarque portao 244"
                        ></StatusBoxSmall>
                        <StatusBoxSmall
                            type="air"
                            status="aviao taxiando"
                        ></StatusBoxSmall>
                        <StatusBoxSmall
                            type="air"
                            status="embarque em 40 min"
                        ></StatusBoxSmall>
                        <StatusBoxSmall
                            type="bag"
                            status="bagagem em pesagem"
                        ></StatusBoxSmall>
                        <StatusBoxSmall
                            type="bag"
                            status="bagagem em separacao"
                        ></StatusBoxSmall>
                        <StatusBoxSmall
                            type="air"
                            status="check-in concluido"
                        ></StatusBoxSmall>
                    </div>
                </Grid>
            </Box>
